...
const NotificationToast = () => (
  <View className="mx-4 mt-2 mb-1 flex-row items-center gap-3 p-3" style={styles.toastContainer}>
    <View style={styles.notificationCircle} className="items-center justify-center">
      <BellIcon />
    </View>
    <View className="flex-1">
      <Text style={styles.toastTitle}>New Activity</Text>
      <Text style={styles.toastSubtitle}>
        You received 0.5 ETH from 0xAb3...f21e
      </Text>
    </View>
  </View>
);
...
export const HomeWithNotification = () => {
