...
const PendingToast = () => (
  <View className="mx-4 mt-2 mb-1 flex-row items-center gap-3 p-3" style={styles.toastContainer}>
    <View style={styles.pendingCircle} className="items-center justify-center">
      <UpArrowIcon />
    </View>
    <View className="flex-1">
      <Text style={styles.toastTitle}>Sending Tokens</Text>
      <Text style={styles.toastSubtitle}>
        Captainz#4451 will be withdrawn from your wallet once the transaction is complete
      </Text>
    </View>
  </View>
);
