...
const PendingToast = () => (
  <View className="mx-4 mt-2 mb-1 flex-row items-center gap-3 p-3" style={styles.toastContainer}>
    <View style={styles.swapCircle} className="items-center justify-center">
      <SwapArrowsIcon />
    </View>
    <View className="flex-1">
      <Text style={styles.toastTitle}>Swapping Tokens</Text>
      <Text style={styles.toastSubtitle}>
        USDC will be withdrawn from your wallet once the transaction is complete
      </Text>
    </View>
  </View>
);
